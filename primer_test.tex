...
La heurística trata de la resolución de problemas aplicando soluciones
parciales, a menudo intuitivas. Se procede por un metodo iterativo
que, poco a poco, se aproxima a la una solución o resultado. Una
heurística es un criterio, método o principio para decidir que acción
